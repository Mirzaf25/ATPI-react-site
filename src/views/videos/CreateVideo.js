...
class CreateVideo extends React.Component {
  ...
  createVideo() {
    const formData = new FormData(document.getElementById("create-video-form"));
    const data = { acf: {} };
                  ...
                  >
                      ...
                      <Col>
                        ...
                        <div className="MuiInputBase-root MuiOutlinedInput-root MuiInputBase-formControl">
                          <Input
                            ...
                            onFocus={(e) => {
                              document
                                .getElementById("label-date")
                                .classList.add(
                                  "Mui-focused",
                                  "MuiInputLabel-shrink"
                                );
                              e.target.parentNode.classList.add("Mui-focused");
                              document
                            ...
                            onBlur={(e) => {
                              ...
                              if (e.target.value !== "") {
                                document
                                  .getElementById("label-date")
                                  .classList.add("MuiInputLabel-filled");
                    ...
                    <FormGroup row>
                      <Col>
                        ...
                        >
                          {this.state.organizers_show.length !== 0 &&
                            this.state.organizers_show.map((organizer, key) => (
                              <MenuItem
                                key={key}
                                value={parseInt(organizer.id)}
                              >
                                <Checkbox
                                  checked={
                                ...
                                />
                                <ListItemText
                                  primary={organizer.title.rendered}
                                />
                              </MenuItem>
                            ))}
                        </Select>
