						...
						<div className='col'>
							<Card className='shadow'>
								...
								<CardBody>
									<div
										style={{
											display: this.state.uploadAreaOpen
												? 'block'
												: 'none',
											transform: 'scaleY(1)',
									...
									>
										<form className='my-form'>
											<p>
												Upload (multiple files -- will
												be done) single file with the
												file dialog or by dragging and
												dropping images onto the dashed
												region
											</p>
											<input
												type='file'
